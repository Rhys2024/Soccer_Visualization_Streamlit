...
data_squads = pd.read_csv(f"data/Squads_all_data.csv")
...
new_grouped_stats_player_comparison = {'Goalscoring': {'Goals': {'normal_name': 'Performance - Gls',
 ...
 'Passing': {'Assists': {'normal_name': 'Ast',
  ...
  'Long Pass Completion %': {'normal_name': 'Long - Cmp%',
   'per_90_name': 'Long - Cmp% per 90',
   'is_inverse': False},
  'Expected Assists': {'normal_name': 'xA',
   'per_90_name': 'xA per 90',
   'is_inverse': False},
  'Assists - xA': {'normal_name': 'A-xAG',
